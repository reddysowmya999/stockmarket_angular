...
@Component({
  selector: 'app-summaryofupload',
  templateUrl: './summaryofupload.component.html',
  styleUrls: ['./summaryofupload.component.css']
})
export class SummaryofuploadComponent implements OnInit {
